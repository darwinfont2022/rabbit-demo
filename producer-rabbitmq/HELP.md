docker run -d --hostname demo-rabbit --name rabbit -e RABBITMQ_DEFAULT_USER=user -e RABBITMQ_DEFAULT_PASS=password -p 5672:5672 rabbitmq:3-management
# Read Me First
The following was discovered as part of building this project:

* No Docker Compose services found. As of now, the application won't start! Please add at least one service to the `compose.yaml` file.
* The original package name 'com.darwinfont.demo-rabbitmq' is invalid and this project uses 'com.darwinfont.demorabbitmq' instead.
...
```
$ docker run --rm -p 8080:8080 demo-rabbitmq:0.0.1-SNAPSHOT
```
